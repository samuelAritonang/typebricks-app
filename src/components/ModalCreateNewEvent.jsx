...
export default function ModelCreateNewEvent() {
    ...
    return (
        <>
            <div className="mb-5">
                <button onClick={()=>setIsShow(true)} className="border bg-red-400 px-5">
                    Create new event -perbaikan
                </button>
            </div>

            <div id="default-modal" tabindex="-1" aria-hidden="true" className={ ` ${!isShow?"hidden":"block"} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
